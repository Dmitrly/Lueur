...
const SinglePost: React.FC<IPost> = ({author_id, body, likes, title, _id, image}) => {
    ...
    return (
        <>
            <div style={{boxShadow: '0px 5px 6px 5px #E6E5E5'}} className={`relative bg-white py-8 px-10 rounded-3xl w-[900px] mt-10 ${nunito_font.className} tracking-wider`}>
                ...
                {/* AVATAR */}
                <div className="absolute overflow-hidden top-0 left-[-110px] rounded-full w-[80px] h-[80px]">
